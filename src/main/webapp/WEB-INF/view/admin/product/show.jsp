                ...
                <table class="table table-bordered mt-5">
                    ...
                    <c:forEach var="product" items="${products}">
                        <tr>
                            <th>${product.id}</th>
                            <th>${product.name}</th>
                            <th><fmt:formatNumber value="${product.price}" type="currency" currencySymbol=""/> VND</th>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item"><a class="${1 eq currentPage ? 'disabled page-link' : 'page-link'}"
                                                 href="/admin/product?page=${currentPage -1 }">Previous</a></li>
                        ...
                        <li class="page-item"><a
                                ...
                                href="/admin/product?page=${currentPage +1 }">Next</a></li>
                    </ul>
                </nav>
            </div>
        </main>

                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <form:input
                                                        class="form-control ${not empty errFirstName ? 'is-invalid' : ''}"
                                                        id="inputFirstName"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input
                                                        class="form-control ${not empty errLastName ? 'is-invalid' : ''}"
                                                        id="inputLastName"
                                    ...
                                    <div class="form-floating mb-3">
                                        <form:input class="form-control ${not empty errEmail ? 'is-invalid' : ''}"
                                                    type="email"
                                                    path="email"/>
